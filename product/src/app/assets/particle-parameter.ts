export class ParticleParameter {
  ...
  private setting0 = {
    ...
    property   : {
      ...
      'startX'                  : 240.66666666666666,
      'startXVariance'          : '0',
      'startY'                  : 183.33333333333334,
      'startYVariance'          : '0',
      'shapeIdList'             : ['circle'],
      'startColor'              : {
        'hue'               : '0',
  ...
  private setting1 = {
    ...
    property   : {
      ...
      'startY'                  : 183.33333333333334,
      'startYVariance'          : '0',
      'shapeIdList'             : ['circle', 'reverse_blur_circle', 'star'],
      'startColor'              : {
        'hue'               : '0',
        'hueVariance'       : '0',
        'saturation'        : '92',
  ...
  private setting5 = {
    ...
    property   : {
      ...
      'startY'                  : 98,
      'startYVariance'          : '107',
      'shapeIdList'             : ['blur_circle', 'star', 'circle', 'kirakira'],
      'startColor'              : {
        'hue'               : '297',
        'hueVariance'       : '99',
        'saturation'        : '76',
  ...
  private setting9 = {
    ...
    property   : {
      ...
      'startY'                  : 183.33333333333334,
      'startYVariance'          : '98',
      'shapeIdList'             : ['blur_circle', 'kirakira2', 'kirakira', 'star'],
      'startColor'              : {
        'hue'               : '88',
        'hueVariance'       : '99',
        'saturation'        : '76',
